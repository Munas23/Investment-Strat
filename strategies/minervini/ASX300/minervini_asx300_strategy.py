"""
Mark Minervini's Complete Championship Strategy - ASX300 Implementation
====================================================================

This implements Minervini's complete methodology for the Australian market:
1. Fundamental screening (only trade quality ASX300 stocks >60% score)
...
4. Enhanced pyfolio analysis and reporting

Tests on the complete ASX 300 universe for Australian market exposure.
"""
...
class MinerviniASX300Strategy(Strategy):
    """
    Enhanced Minervini Strategy for ASX300 with Pyfolio Integration
    
    Combines:
    1. Fundamental screening + technical timing + risk management
    2. ASX300 universe (Australian market)
    3. Comprehensive pyfolio analysis and reporting
    4. Professional-grade tear sheets and metrics
    """
    ...
    def initialize(self):
        ...
        # Debug tracking (same as original)
        self.debug_stats = {
        ...
        self.log_message("=== MINERVINI ASX300 STRATEGY WITH PYFOLIO ===")
    ...
    def get_asx300_symbols(self):
        ...
        try:
            ...
            # This is a sample of major ASX300 stocks - in practice you'd get the full list
            asx300_sample = [
                # Big 4 Banks
    ...
    def on_strategy_end(self):
        ...
        self.log_message("=== MINERVINI ASX300 STRATEGY COMPLETED ===")
        
        # Save basic CSV
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        if self.trades_log:
            trades_df = pd.DataFrame(self.trades_log)
            csv_filename = f"minervini_asx300_trades_{timestamp}.csv"
        ...
        self.log_message("=" * 80)
        self.log_message("ASX300 STRATEGY PERFORMANCE & DEBUGGING")
        self.log_message("=" * 80)
        ...
        self.log_message("=" * 80)
        self.log_message("ASX300 strategy completed - Check CSV and pyfolio reports")
    ...
    def generate_pyfolio_analysis(self, timestamp):
        ...
        try:
            ...
            plt.savefig(f"{output_dir}/asx300_returns_tearsheet_{timestamp}.png", 
                       dpi=300, bbox_inches='tight')
            plt.close('all')
            self.log_message(f"✓ Returns tear sheet saved: asx300_returns_tearsheet_{timestamp}.png")
            ...
            plt.savefig(f"{output_dir}/asx300_simple_tearsheet_{timestamp}.png", 
                       dpi=300, bbox_inches='tight')
            plt.close('all')
            self.log_message(f"✓ Simple tear sheet saved: asx300_simple_tearsheet_{timestamp}.png")
            
            # 3. Generate and save key metrics to text file
            metrics_filename = f"{output_dir}/asx300_performance_metrics_{timestamp}.txt"
    ...
    def save_performance_metrics(self, returns, benchmark, filename):
        ...
        try:
            with open(filename, 'w') as f:
                f.write("MINERVINI ASX300 STRATEGY PERFORMANCE METRICS\n")
                f.write("=" * 50 + "\n\n")
    ...
    def create_basic_performance_report(self, returns, benchmark, timestamp):
        ...
        try:
            ...
            axes[0,0].plot(cum_returns.index, cum_returns, label='ASX300 Strategy', linewidth=2)
            ...
            # Save plot
            plot_filename = f"pyfolio_reports/asx300_performance_{timestamp}.png"
...
def run_asx300_minervini_backtest():
    """Run complete Minervini championship strategy backtest on ASX300"""
    try:
        print("=" * 80)
        print("MARK MINERVINI'S COMPLETE STRATEGY - ASX300 EDITION")
        print("=" * 80)
        print("Features:")
        print("✓ Fundamental screening + Technical timing (Australian market)")
        print("✓ Championship risk management")
        ...
        results = MinerviniASX300Strategy.backtest(
        ...
        print("\n🎉 ASX300 MINERVINI STRATEGY COMPLETED!")
        print("✓ Basic CSV trade log exported")
        if PYFOLIO_AVAILABLE:
            print("✓ Pyfolio tear sheet generated")
            print("✓ Professional performance analysis vs ASX300")
        print("✓ Enhanced reporting with Australian market focus")
        
        return results
        
    except Exception as e:
        print(f"Error in ASX300 backtest: {e}")
        import traceback
        traceback.print_exc()
        return None
...
if __name__ == "__main__":
    print("Starting Minervini ASX300 Strategy with Pyfolio Analysis...")
    results = run_asx300_minervini_backtest()